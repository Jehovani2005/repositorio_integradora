...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE PRODUCCIONES ACADÉMICAS DEL CUERPO ACADÉMICO:"), 0, 1, 'C', 0);
      $this->SetTextColor(228, 100, 0);
      $this->Cell(88); // mover a la derecha
      $this->SetFont('Arial', 'B', 18);
      ...
      $this->Cell(110, 10, utf8_decode('PROYECTO DE INVESTIGACIÓN DEL CUAL SE GENERO'), 1, 0, 'C', 1);
