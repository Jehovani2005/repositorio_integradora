...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE DOCENTES DEL CUERPO ACADÉMICO:"), 0, 1, 'C', 0);
      $this->SetTextColor(228, 100, 0);
      $this->Cell(88); // mover a la derecha
      $this->SetFont('Arial', 'B', 18);
      ...
      $this->Cell(58, 10, utf8_decode('NOMBRE'), 1, 0, 'C', 1);
      $this->Cell(55, 10, utf8_decode('ÁREA DE ADSCRIPCIÓN'), 1, 0, 'C', 1);
      $this->Cell(28, 10, utf8_decode('TELÉFONO'), 1, 0, 'C', 1);
...
$consulta = "SELECT id_docente,nombre, area_adscripcion,telefono,lider,correo,(SELECT MD5(contrasena)) AS codificado 
            FROM docentes WHERE nombre_cuerpo='$nombre_cuerpo' ";
...
while ($row = mysqli_fetch_array($result)) { 
                        ...
                        $id = utf8_decode($row['id_docente']);
                         ...
                         $area = utf8_decode($row['area_adscripcion']);
                         ...
                         $pdf->Row([$id, $nombre, $area, $telefono, $lider, $correo, $contrasena]);
