...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Lineas de Investigación Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLineas" aria-expanded="true" aria-controls="collapseLineas">
                    <i class="fa fa-folder"></i>
                    <span>Lineas de <br> Investigación</span>
                </a>
                <div id="collapseLineas" class="collapse" aria-labelledby="headingLineas" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="?cargar=inicioLinea">Consultar</a>
                        <a class="collapse-item" href="?cargar=crearLinea">Registrar</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Reporte Parametro -->
            <li class="nav-item">
                <a class="nav-link" href="?cargar=paramReporteProyecto">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Reportes de Proyectos <br> de Investigación Por Año  </span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="img/logo_oficial.png" alt="Logo" style="height: 75px;">
                    </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href=?cargar=editarDocente&id_docente=<?php echo $_SESSION['id_docente']; ?>>
