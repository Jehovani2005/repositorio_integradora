                        ...
                        */
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href=?cargar=editar&id=<?php echo $row['id_linea']; ?> class="btn btn-warning"><i class="fas fa-edit" aria-hidden="true"></i></a>
                            </td>
...
<script language="javascript">
        function confirmar(id_linea){
            ...
            window.location.href='?cargar=eliminar&id_linea='+id_linea;
