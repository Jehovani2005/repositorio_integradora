...
if (isset($_POST)) {
    $buscar = @$_POST['buscar'];
    $resultado = $linea->filtrar($buscar);
} else {
    $resultado = $linea->listar();
}
?>

<!-- Encabezado o Titulo -->
<!--Este div es para lo del PDF --><div class="d-flex justify-content-between align-items-center">
<h1 class="h3 mb-4 text-gray-800">Lineas de Investigación del Cuerpo Académico: <strong><?= $_SESSION['nombre_cuerpo']?></strong></h1>
                        <a href="../../../../../bienvenida/gestordeproyectos/fpdf/reporte_lineas.php" target="_blank" class="btn btn-success btn-icon-split">
...
<p class="mb-4">En este apartado puedes generar reportes en PDF, realizar consultas por nombre, modificar
    y eliminar registros de las Lineas de Investigación.
</p>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Lineas de Investigación Registrados</h6>
    </div>
    <div class="card-body">
                        ...
                        */
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href=?cargar=editarLinea&id_linea=<?php echo $row['id_linea'];
                                ?> class="btn btn-warning"><i class="fas fa-edit" aria-hidden="true"></i></a>
                            </td>

                            <td>
                                <!--Este es el boton de ELIMINAR-->
                                <a  onClick='confirmar(<?php echo $row['id_linea']; ?> )' class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
...
<script languaje = "javascript">
    function confirmar(id_linea){
        ...
        function(){
            window.location.href='?cargar=eliminarLinea&id_linea='+MyId;
        });
    }
</script>