...
<!-- Encabezado o Titulo -->
<h1 class="h3 mb-4 text-gray-800">Modificar Producción Académica del Cuerpo Académico: <strong><?= $_SESSION['nombre_cuerpo']?></strong></h1>
<div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_publicacion" name="fecha_publicacion" value="<?php echo $row['fecha_publicacion']; ?>" placeholder="Ingresa la fecha de publicación" 
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="proyec_inv_gen" name="proyec_inv_gen" required>
                                    ...
                                    $getproyecto1 = "SELECT * FROM proyecto_investigacion WHERE nombre_cuerpo='$nombre_cuerpo'
                                                    ORDER BY nombre";
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipo" id="tipo">
                                    ...
                                    include '../../clases/conexion.php';
                                    $conexion = new conexion();
                                    $gettipo1 = "SELECT * FROM tipos ORDER BY tipo";
                                    $gettipo2 = $conexion->consultaRetorno($gettipo1);

                                    while ($row_tipo = mysqli_fetch_assoc($gettipo2)) {
                                        $tipo = $row_tipo['tipo'];
                                    ?>
                                        <option value="<?php echo $tipo; ?>" <?php echo ($tipo == $row['tipo']) ? 'selected' : ''; ?>>
                                            <?php echo $tipo; ?>
                                        </option>
                                    <?php
                                    }
