...
<!-- Encabezado o Titulo -->
<h1 class="h3 mb-4 text-gray-800">Registrar Producción Académica del Cuerpo Académico: <strong><?= $_SESSION['nombre_cuerpo']?></strong></h1>
<div class="container">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipo" id="tipo" required>
                                    ...
                                    while ($row = mysqli_fetch_array($gettipo2)) {
                                        $id = $row['id_tipo'];
                                        $tipo = $row['tipo'];
