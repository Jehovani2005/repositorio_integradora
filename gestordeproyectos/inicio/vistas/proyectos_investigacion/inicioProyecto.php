...
<!-- Encabezado o Titulo -->
<!--Este div es para lo del PDF -->
<div class="d-flex justify-content-between align-items-center">
    <h1 class="h3 mb-4 text-gray-800">Proyectos de Investigación del Cuerpo Académico: <strong><?= $_SESSION['nombre_cuerpo']?></strong></h1>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $fecha_formateada1; ?></td>
                            <td><?php echo $fecha_formateada2; ?></td>
                            <td><?php echo $row['descripcion']; ?></td>
                            <td><?php echo $row['responsable']; ?></td>
                            <td><?php echo $row['linea_aplica']; ?></td>
                            <td>
